...
filtro_iir = np.load('0.7-15.npz', allow_pickle=True) 
...
print("\r\n")
print("Filtro IIR:")
filter_parameters.filter_parameters('0.7-15.npz')
print("\r\n")
...
# A modo de ejemplo se levanta la primer captura del eje Z del Dataset 
senial = signal.resample(y[3, 0:N], N_resample)
...
filtro_iir = np.load('filtro_0.5-10.npz', allow_pickle=True) 
...
print("\r\n")
print("Filtro IIR:")
filter_parameters.filter_parameters('filtro_0.5-10.npz')
print("\r\n")
